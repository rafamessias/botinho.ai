...
const INPUT_FILE = path.join(__dirname, '../components/survey-render/survey-widget-minimal.js');
const OUTPUT_FILE = path.join(__dirname, '../public/survey-widget-minimal.min.js');

async function minifyMinimalWidget() {
    try {
        console.log('📦 Starting minimal survey widget minification...');
