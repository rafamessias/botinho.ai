...
const ContainerApp = ({ children, form = true, title = "", showBackButton = false, editButton = "" }: { children: React.ReactNode, form?: boolean, title?: string, showBackButton?: boolean, editButton?: string }) => {
    return (
        <>
